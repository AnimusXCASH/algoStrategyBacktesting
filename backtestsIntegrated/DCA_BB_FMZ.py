...
from strategies.dca_bb_fmz import DCABbFMZ
...
####################################### OPTIMIZATION ##############################################################
    ...
    # initial_trade_size_percentage_range = (2.0, 8.0, 2.0 )
    # trade_size_multiplier_range = np.arange(2.0, 7.0, 1)
    # take_profit_percentage_range = np.arange(1.0, 6.0,1)
    ...
    # num_trade_size_multiplier_range = len(trade_size_multiplier_range)
    # num_take_profit_percentage_range = len(take_profit_percentage_range)

    # # Calculate the total number of tests
    # total_tests = (num_price_drop_percentage *
    #             num_initial_trade_size_percentage_range *
    #             num_trade_size_multiplier_range *
    ...
    #     trade_size_multiplier=trade_size_multiplier_range,
