...
def plot_ohlcv_with_emas(df, symbol):
    ...
    if alignment_index is not None:
        ...
        swing_low_index, swing_low_price = find_swing_low(df, alignment_index)
        ...
        swing_high_index, swing_high_price = find_swing_high(df, alignment_index)
...
df_5m = df_5m.tail(400)  # Focus on the last 100 rows for clarity
